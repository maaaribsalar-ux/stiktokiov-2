...
const SassClassic = () => (
  <svg width="24px" height="24px" viewBox="0 0 24 24" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink">
    ...
    <g id="Stockholm-icons-/-Devices-/-Display#2" stroke="none" strokeWidth={1} fill="none" fillRule="evenodd">
      <rect id="bound" x={0} y={0} width={24} height={24} />
      <polygon id="Combined-Shape" fill="#335EEA" opacity="0.3" points="6 7 6 15 18 15 18 7" />
      <path
...
const Coworking = () => (
  <svg width="24px" height="24px" viewBox="0 0 24 24" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink">
    ...
    <desc>Created with Sketch.</desc>
    <g id="Stockholm-icons-/-Home-/-Home" stroke="none" strokeWidth={1} fill="none" fillRule="evenodd">
      <rect id="bound" x={0} y={0} width={24} height={24} />
      <path
  ...
  <svg
    ...
    <g stroke="none" strokeWidth={1} fill="none" fillRule="evenodd">
      ...
      <path
        ...
        fill="currentColor"
      />
      <polygon id="Combined-Shape" fill="currentColor" opacity="0.3" points="6 8 6 16 18 16 18 8" />
    </g>
  </svg>
)
const Startup = () => (
  <svg
    ...
    <g stroke="none" strokeWidth={1} fill="none" fillRule="evenodd">
      <rect id="bound" x={0} y={0} width={24} height={24} />
      <rect id="Combined-Shape" fill="currentColor" opacity="0.3" x={2} y={3} width={20} height={18} rx={2} />
      <path
        ...
        fill="currentColor"
      />
      <circle id="Oval" fill="currentColor" opacity="0.3" cx={19} cy={6} r={1} />
    </g>
  </svg>
)
const Agency = () => (
  <svg className="text-black w-6 h-6" viewBox="0 0 24 24" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink">
    <g stroke="none" strokeWidth={1} fill="none" fillRule="evenodd">
      <rect id="bound" x={0} y={0} width={24} height={24} />
      <path
...
const Crypto = () => (
  <svg
    ...
    <g stroke="none" strokeWidth={1} fill="none" fillRule="evenodd">
      <rect id="bound" x={0} y={0} width={24} height={24} />
      <rect id="Rectangle" fill="currentColor" opacity="0.3" x={11} y={2} width={2} height={5} rx={1} />
      <rect id="Rectangle-Copy-3" fill="currentColor" opacity="0.3" x={11} y={16} width={2} height={5} rx={1} />
      <path
...
const MenuSvg = () => (
  <svg
    ...
    <desc>Created with Sketch.</desc>
    <g id="Stockholm-icons-/-Text-/-Bullet-list" stroke="none" strokeWidth={1} fill="none" fillRule="evenodd">
      <rect id="bound" x={0} y={0} width={24} height={24} />
      <path
...
const HomeSvg = () => (
  <svg width="24px" height="24px" viewBox="0 0 24 24" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink">
    ...
    <g stroke="none" strokeWidth={1} fill="none" fillRule="evenodd">
      <rect id="bound" x={0} y={0} width={24} height={24} />
      <rect id="Rectangle-7" fill="currentColor" x={4} y={4} width={7} height={7} rx="1.5" />
      <path
...
const ProjectSvg = () => (
  <svg width="24px" height="24px" viewBox="0 0 24 24" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink">
    ...
    <desc>Created with Sketch.</desc>
    <g id="Stockholm-icons-/-Files-/-Group-folders" stroke="none" strokeWidth={1} fill="none" fillRule="evenodd">
      <rect id="bound" x={0} y={0} width={24} height={24} />
      <path
...
const TaskSvg = () => (
  <svg width="24px" height="24px" viewBox="0 0 24 24" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink">
    ...
    <desc>Created with Sketch.</desc>
    <g id="Stockholm-icons-/-Text-/-Article" stroke="none" strokeWidth={1} fill="none" fillRule="evenodd">
      <rect id="bound" x={0} y={0} width={24} height={24} />
      <rect id="Rectangle-20" fill="currentColor" x={4} y={5} width={16} height={3} rx="1.5" />
      <path
...
const ReportSvg = () => (
  <svg width="24px" height="24px" viewBox="0 0 24 24" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink">
    ...
    <g id="Stockholm-icons-/-Media-/-Equalizer" stroke="none" strokeWidth={1} fill="none" fillRule="evenodd">
      <rect id="bound" x={0} y={0} width={24} height={24} />
      <rect id="Rectangle-62-Copy" fill="currentColor" opacity="0.3" x={13} y={4} width={3} height={16} rx="1.5" />
      <rect id="Rectangle-62-Copy-2" fill="currentColor" x={8} y={9} width={3} height={11} rx="1.5" />
      <rect id="Rectangle-62-Copy-4" fill="currentColor" x={18} y={11} width={3} height={9} rx="1.5" />
      <rect id="Rectangle-62-Copy-3" fill="currentColor" x={3} y={13} width={3} height={7} rx="1.5" />
    </g>
  </svg>
)
...
const SettingSvg = () => (
  <svg width="24px" height="24px" viewBox="0 0 24 24" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink">
    ...
    <desc>Created with Sketch.</desc>
    <g id="Stockholm-icons-/-Shopping-/-Settings" stroke="none" strokeWidth={1} fill="none" fillRule="evenodd">
...
const NotificationSvg = () => (
  <svg width="24px" height="24px" viewBox="0 0 24 24" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink">
    ...
    <desc>Created with Sketch.</desc>
    <g id="Stockholm-icons-/-General-/-Notification#2" stroke="none" strokeWidth={1} fill="none" fillRule="evenodd">
      <rect id="bound" x={0} y={0} width={24} height={24} />
      <path
        ...
        fill="currentColor"
      />
      <circle id="Oval" fill="currentColor" opacity="0.3" cx="18.5" cy="5.5" r="2.5" />
    </g>
  </svg>
)
...
const ChatCheckSvg = () => (
  <svg width="24px" height="24px" viewBox="0 0 24 24" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink">
    ...
    <desc>Created with Sketch.</desc>
    <g id="Stockholm-icons-/-Communication-/-Chat-check" stroke="none" strokeWidth={1} fill="none" fillRule="evenodd">
      <rect id="bound" x={0} y={0} width={24} height={24} />
      <path
  ...
  <svg width="24px" height="24px" viewBox="0 0 24 24" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink">
    ...
    <g id="Stockholm-icons-/-General-/-Like" stroke="none" strokeWidth={1} fill="none" fillRule="evenodd">
      ...
      <path
        ...
        fill="currentColor"
      />
      <rect id="Rectangle-153" fill="currentColor" opacity="0.3" x={2} y={9} width={5} height={11} rx={1} />
    </g>
  </svg>
)
