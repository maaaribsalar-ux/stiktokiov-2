  ...
  },
  {
    icon: (
      <svg width="24px" height="24px" viewBox="0 0 24 24" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink">
        ...
        <desc>Created with Sketch.</desc>
        <g id="Stockholm-icons-/-General-/-Shield-check" stroke="none" strokeWidth={1} fill="none" fillRule="evenodd">
          <rect id="bound" x={0} y={0} width={24} height={24} />
          <path
      ...
      <svg width="24px" height="24px" viewBox="0 0 24 24" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink">
        ...
        <g id="Stockholm-icons-/-General-/-Notification#2" stroke="none" strokeWidth={1} fill="none" fillRule="evenodd">
          ...
          <path
            ...
            fill="#335EEA"
          />
          <circle id="Oval" fill="#335EEA" opacity="0.3" cx="18.5" cy="5.5" r="2.5" />
        </g>
      </svg>
    ),
          ...
          <Col lg={5}>
            <div className="img-content position-relative">
              <div className="img-up">
                <Image src={app2} alt="app-img" className="img-fluid d-block" data-aos="zoom-in-right" />
              </div>
            </div>
          </Col>
          <Col lg={7}>
