// types
import { HelpLinkType } from './types'
...
const helpLinks: HelpLinkType[] = [
    ...
    icon: (
      <svg
        ...
        <g stroke="none" strokeWidth={1} fill="none" fillRule="evenodd">
          ...
          />
          <rect id="Rectangle" fill="currentcolor" opacity="0.3" x={12} y={17} width={10} height={2} rx={1} />
        </g>
      </svg>
    ),
  ...
  },
  {
    ...
    links: ['Account information', 'Identity verification', 'Linking a payment method'],
  },
  {
    icon: (
      <svg
